# 주소록 만들기
# 클래스를 이용하면 로직과 데이터를 관련있는 것끼리 묶을 수 있음!
...
class Main:
    ...
    def add(self):
        name = input("[3]주소추가 | 이름을 입력해주세요 : ")
        number = input("[3]주소추가 | 번호를 입력해주세요 : ")
...
if __name__ == '__main__':
    main = Main(AddressBook("아름이의 주소록"))
    main.run()
